...
const columns = [
    ...
    },
    {
        ...
        render: (data) => {
            return data
                ? `<a href="./../../../../images/sos/attachment/${data}" target="_blank"><em class="ni ni-clip me-1"></em>Download</a>`
                : "";
        },
    },
    {
        ...
        className: "align-content-center",
        render: (data) => {
            return `<a href="${route('sos.show', data.id)}" target="_blank" class="mx-2"><em class="ni ni-monitor me-1"></em></a>`;
        },
    },
];
...
const handleSubmitForm = () => {
    ...
    const url = route("reports.incident", queryParams);
                ...
                <div class="card-inner">
                    ...
                    >
                        ...
                        <template #column-4="{ rowData }">
                            <a
                                :href="route('sos.show', rowData.id)"
                                class="btn btn-icon"
                                target="_blank"
                            >
